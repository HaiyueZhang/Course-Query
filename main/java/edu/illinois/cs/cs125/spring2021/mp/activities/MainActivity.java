...
public final class MainActivity extends AppCompatActivity
  ...
  public boolean onQueryTextSubmit(final String unused) {
    List<Summary> selectedCourses;
    selectedCourses = Summary.filter(courses, unused);
    listAdapter.edit().replaceAll(selectedCourses).commit();
    return true;
  }
  ...
  public boolean onQueryTextChange(final String query) {
    List<Summary> selectedCourses;
    selectedCourses = Summary.filter(courses, query);
    listAdapter.edit().replaceAll(selectedCourses).commit();
    return true;
  }
  ...
  public void onCourseClicked(final Summary course) {
    ...
    try {
      courseIntent.putExtra("COURSE", objectMapper.writeValueAsString(course));
